...
export function AsidePets({
  ...
  return (
    <aside
      ...
      className={`bg-pets-color-600 inset-0 px-3 font-roboto py-4 rounded-xl h-fit shadow-custom sticky top-5 transition-all w-20 ${isHover ? width : "w-20"}`}
    >
